...
- 2026-05-03: Regression fix landed (shared with WP-I1-017 + WP-I1-029). `viewport_openpose.update_rig()` now passes `frame`; new regression test guards the polling path. Full suite 281/281. Status IN-PROGRESS -> REVIEW.
