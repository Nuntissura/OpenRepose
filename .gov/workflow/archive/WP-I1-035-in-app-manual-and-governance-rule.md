...
- 2026-05-03: Follow-up debug pass fixed the Windows audit-test harness: `.product/tests/test_audit_repo.py` now invokes PowerShell with `-ExecutionPolicy Bypass`, matching the repo's documented audit invocation. Taskboard drift also corrected: WP-I1-034/WP-I1-035 are Pending Review, I2 remains Pending Review, WP-I3-001 is DONE, and only true DRAFT workpackets remain in the Draft table. Focused audit tests pass; repo audit clean.
