...
def test_app_boots_with_live_db_and_runs_migrations(pool_pg, tmp_path: Path):
    ...
    reflects connected=true / schema_version=1."""
    import json
    ...
    try:
        ...
        assert app.library_pool.schema_version() == 1
        ...
        assert lib.get("schema_version") == 1
...
def test_pool_schema_version_after_migration(pool_pg):
    """After running 001_library_initial.sql, schema_version() reads 1."""
    import psycopg
